...
if(!empty($_SESSION['check']) && $_SESSION['check']==$sec_k){
    ...
    while ($rowPers= mysqli_fetch_array($perstSelect)) {
        ...
        <form id="persents">
            <h2 class="white-text">Секция 3</h2>
            <div class="persLin">
                <div class="row">
            ...
            <h2 class="white-text">Секция 4</h2>
            <div class="persLin">
                <div class="row">
                    <div class="input-field col s4" >
                        <input type="text" id="generalConstruction" name="pers5" value="<?=$rowPers['persent_5'];?>">
                        <label for="generalConstruction">Общестроительные</label>
                    </div>
                    <div class="input-field col s8" >
                        <textarea name="opP5" class="materialize-textarea" id="generalConstructionSpecified" rows="5"><?=$rowPers['perOpis_5'];?></textarea>
                        <label for="generalConstructionSpecified">Работы до отм./Каркас/Кирпичная кладка/Внутренняя отделка</label>
                    </div>
                </div>
            </div>
            <div class="persLin">
                <div class="row">
                    <div class="input-field col s4">
                        <input type="text" id="facade" name="pers6" value="<?=$rowPers['persent_6'];?>">
                        <label for="facade">Фасад</label>
                    </div>
                    <div class="input-field col s8">
                        <textarea name="opP6"  class="materialize-textarea" id="generalFacade" rows="5"><?=$rowPers['perOpis_6'];?></textarea>
                        <label for="generalFacade">Окна/Фасад</label>
                    </div>
                </div>
            </div>
            <div class="persLin">
                <div class="row">
                    <div class="input-field col s4">
                        <input type="text" id="networks" name="pers7" value="<?=$rowPers['persent_7'];?>">
                        <label for="networks">Сети</label>
                    </div>
                    <div class="input-field col s8">
                        <textarea name="opP7" class="materialize-textarea" id="generalNetworks" rows="5"><?=$rowPers['perOpis_7'];?></textarea>
                        <label for="generalNetworks">Внутриние/Внешние</label>
                    </div>
                </div>
            </div>
            <div class="persLin">
                <div class="row">
                    <div class="input-field col s4">
                        <input type="text" id="beautification" name="pers8" value="<?=$rowPers['persent_8'];?>">
                        <label for="beautification">Благоустрой</label>
                    </div>
                    <div class="input-field col s8">
                        <textarea name="opP8" class="materialize-textarea" id="generalBeautification" rows="5"><?=$rowPers['perOpis_8'];?></textarea>
                        <label for="generalBeautification"></label>
                    </div>
                </div>
            </div>
