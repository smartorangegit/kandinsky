            ...
            <div class="nav-content">
                ...
                <div class="bot_div">
                    <div class="b_chi_1">
						...
						<p>
                            <input type="radio" name="section_number" id="section_number_3" class="with-gap" value="3" <?if($myrow['section_number']==3){echo 'checked';}?>>
                            <label for="section_number_3">Секция 3</label>
                        </p>

                        <p>
                            <input type="radio" name="section_number" id="section_number_4" class="with-gap" value="4" <?if($myrow['section_number']==4){echo 'checked';}?>>
                            <label for="section_number_4">Секция 4</label>
                        </p>
						<!-- Конец выбора секции -->
                        <p>
