<div class="zag__form_wrapper form_zag" >
	<form  class="zag__form" id="form_zag">
		<p class="form__title"><span class="italic-text"><?=$mes['Заказать звонок']?></p>
		...
		<input class="inputtelmask" onkeyup="javascript:countme('form_zag');" name="tel" required type="tel" placeholder="<?=$mes['Телефон:']?>*" >
