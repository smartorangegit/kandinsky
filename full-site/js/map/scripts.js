...
function initMap() {
  ...
  var centerX = 46.466628;
  var centerY = 30.757518;
  ...
  if( windowWidth < 992 && windowWidth > 600) {
   ...
   console.log(centerX);
  var contentString = '<div class="map__info-marker">' + '<h3><img class="main__marker_logo" src="/img/main-logo.png" height="52" width="165" alt=""></h3>' +    
    '<p><i class="map-ico"></i> Адресс: ул. Владимирская, 86 А</p>' + '</div>';
  
  var locations = [
    [contentString,46.466628, 30.757518, "/img/location/main-marker.png"]
  ];
  var infowindow = new google.maps.InfoWindow();
  ...
  var icons = {
    suvenire: {
      icon: iconBase + 'small-marker-1.png'
    },
    sport: {
      icon: iconBase + 'small-marker-2.png'
    },
    education: {
      icon: iconBase + 'small-marker-3.png'
    }
  };
   
  var features = [
    {
      position: new google.maps.LatLng(50.396919, 30.694751),
      type: 'education',
      text: '5555'
    }, {
      position: new google.maps.LatLng(50.393997, 30.695271),
      type: 'education',
       text: '5555'
    }, {    
      position: new google.maps.LatLng(50.394177, 30.698240),
      type: 'education',
       text: '5555'
    }, {
      position: new google.maps.LatLng(50.401003, 30.694843),
      type: 'sport',
       text: '5555'
    } 
  ];

  function filterArr(arr, markerType){
    for (var i = 0; i < arr.length; i++) {
      if(arr[i].type === markerType){
        arr[i].setVisible(true);
      } 
    }
  }
  
  function removeType(arr, markerType){
    for (var i = 0; i < arr.length; i++) {
      if(arr[i].type === markerType){
  ...
  for (var i = 0; i < checkBoxes.length; i++) {
    checkBoxes[i].addEventListener('click', function(){
      ...
      if (this.checked) {
        filterArr(markerArr,type)
      } else {
        removeType(markerArr,type);
      }
    }, false);
  }
*/
...
(function(){
	...
	var timeOut = 7000;
  // SVG B - "Squiggly" Path
  var myPathB = snapB.path("m -30.421055,212.57896 c 0,-0.66227 51.166667,-1 151.500005,-1 h 151.49999 v -44 -44 h 8.97971 8.97971 l 0.27029,20.60624 0.27029,20.60624 18.98849,-20.60624 18.9885,-20.60624 h 10.2615 c 7.11318,0 10.26151,0.35561 10.26151,1.15907 0,0.63748 -4.86337,6.14998 -10.80749,12.25 -5.94412,6.10001 -13.81067,14.26821 -17.48122,18.15155 l -6.67375,7.06062 17.99773,24.43938 c 16.67431,22.6423 18.24096,24.46143 21.30566,24.73928 l 3.30795,0.2999 7.02055,-16.7999 7.02056,-16.7999 22.53787,-0.26848 22.53786,-0.26847 -6.40533,-15.73153 c -3.52294,-8.65233 -7.03396,-17.08152 -7.80228,-18.73152 -1.73921,-3.73505 -7.55811,-18.38296 -7.55811,-19.02603 0,-0.26068 3.98302,-0.47397 8.85116,-0.47397 h 8.85116 l 9.84671,23.25 c 5.41569,12.7875 13.75305,32.475 18.52746,43.75 l 8.68075,20.5 4.61083,0.30436 4.61083,0.30436 0.26055,-43.80436 0.26055,-43.80436 7.8448,-0.29377 c 4.61055,-0.17266 8.38338,0.15321 9.15115,0.79041 0.7185,0.5963 10.68834,13.49747 22.15521,28.66926 l 20.84884,27.58508 0.5,-28.37549 0.5,-28.37549 h 9 9 l 0.26051,43.75 0.26051,43.75 h 16.98949 16.98949 v -6.87155 -6.87155 l 10.75,-0.47406 c 12.33329,-0.54388 16.85127,-2.05899 22.60809,-7.58167 5.54549,-5.31994 7.79521,-11.12256 7.84449,-20.23298 0.0692,-12.79757 -5.03315,-21.29048 -15.70258,-26.13693 -4.57311,-2.07727 -6.7716,-2.30372 -25.75,-2.65227 l -20.75,-0.38108 v -8.51831 -8.51831 l 22.25,0.45815 c 19.7079,0.40581 22.99265,0.71396 28.75,2.69715 12.83556,4.42136 21.86337,12.293 27.21537,23.72995 3.64494,7.78905 4.85966,20.59981 2.79458,29.47223 -2.85729,12.27602 -11.84281,23.62912 -23.16828,29.27284 l -5.23436,2.60839 h 21.68583 21.68584 l 0.26051,-43.75 0.26051,-43.75 h 9 9 l 0.26051,43.75 0.26051,43.75 h 9.47898 9.47898 l 0.26051,-43.75 0.26051,-43.75 8.15433,-0.2889 8.15433,-0.28889 7.92762,10.28889 c 4.3602,5.6589 14.29635,18.72238 22.08035,29.02997 l 14.15274,18.74106 0.26531,-28.74106 0.26532,-28.74107 h 9 9 l 0.26051,43.75 0.26051,43.75 h 13.68066 13.68066 l -5.94117,-3.57488 c -10.33448,-6.21839 -10.18787,-5.77265 -4.21422,-12.81219 2.85304,-3.36211 5.26999,-6.25128 5.37098,-6.42038 0.101,-0.16909 2.60227,1.23974 5.55838,3.13074 7.38901,4.7267 13.71162,6.67738 21.62864,6.67297 10.48209,-0.006 15.61247,-4.29235 13.79662,-11.52728 -0.89318,-3.55873 -5.09287,-5.78074 -17.93068,-9.48691 -23.57453,-6.80579 -29.92775,-12.62648 -29.99632,-27.48207 -0.0263,-5.69021 0.47435,-7.98309 2.67543,-12.25397 6.14357,-11.92077 21.2771,-17.48208 38.78351,-14.25226 5.77846,1.06609 21.88649,8.47327 21.88649,10.06437 0,1.43487 -8.36618,13.89695 -9.34563,13.92105 -0.4651,0.0114 -2.16207,-0.91658 -3.77105,-2.06228 -4.72297,-3.36305 -13.32744,-5.91691 -19.93525,-5.91691 -5.41089,0 -6.43295,0.33103 -9.02499,2.92308 -2.83777,2.83778 -3.62226,6.09128 -2.29975,9.53773 0.91984,2.39706 6.57729,4.95631 18.87667,8.53919 16.91409,4.92718 22.52449,8.3838 26.78091,16.5 1.55044,2.9564 2.09722,5.8263 2.09577,11 -0.002,8.78803 -3.37878,16.04018 -9.54831,20.50937 l -4.12845,2.99063 h 13.15004 13.15004 v -44.03753 -44.03752 l 9.25,0.28752 9.25,0.28753 v 20.25054 c 0,11.1378 0.225,20.20811 0.5,20.15624 0.275,-0.0519 8.85383,-9.16461 19.06407,-20.25054 l 18.56407,-20.15624 10.78086,-0.28479 c 6.49092,-0.17147 10.64361,0.0923 10.43593,0.66287 -0.18971,0.52122 -8.1539,9.09126 -17.69819,19.04452 -9.60028,10.01166 -17.12147,18.65096 -16.83444,19.33712 0.28534,0.68215 4.04431,6.03405 8.35326,11.89311 4.30894,5.85906 12.10944,16.53143 17.33444,23.71637 l 9.5,13.06354 17.75,0.0336 17.75,0.0336 v -16.30778 -16.30777 l -17,-26.79662 c -9.35,-14.73814 -17,-27.21487 -17,-27.72606 0,-0.53192 4.52773,-0.80804 10.58645,-0.6456 l 10.58645,0.28383 10.9993,18.74854 10.9993,18.74855 11.2803,-18.74855 11.28016,-18.74854 10.134,-0.28498 c 6.0023,-0.1688 10.134,0.10622 10.134,0.67453 0,0.52773 -7.65,12.95243 -17,27.61045 l -16.99996,26.65094 v 16.42453 16.42453 h 168.49996 c 111.6667,0 168.5,0.33729 200,1 0,0.66274 -57.3333").attr({
    id: "squiggle",
    fill: "none",
    strokeWidth: "3",
     stroke: '#e5e5e5',
  ...
  myPathB.attr({
	  stroke: '#e5e5e5',
	  strokeWidth: 3,
	  transform:'translate(29.526316,-121.6842)',
    fill: 'none',
    // Draw Path
...
$(".floor-slider").ionRangeSlider({
    ...
    onChange: function(data){
        $('.parametrs__table_list').addClass('blured');
    },
    onFinish: function (data) {
       $('.parametrs__table_list').removeClass('blured');
	    updateInputs ();
  	}
...
navList.find('.menu-open__item_inner').on('mouseover', function(){
  var elemBg = $('.menu-open__pict');
