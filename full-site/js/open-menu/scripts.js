...
function initMap() {
  ...
  /*var features = [
    {
      position: new google.maps.LatLng(46.449227, 30.750498),
      src: icons.gym,
      text: 'Спортивный комплекс, ОНПУ'
    }, {
      position: new google.maps.LatLng(46.4505233,30.742047),
      src: icons.gym,
      text: '<div style="color:red;">УТОГ Спортивный комплекс</div>'
    }
  ];*/
