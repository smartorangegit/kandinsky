<?php  HeadAdd();?>
	<section class="location-main" >
		...
		<div class="container">
			...
			<p class="location-main__description"><?=$mes['Культурные достопримечательности']?></p>
			</div>
			<div class="view-more">
	...
	<div class="wrapper">
				...
				<div class="container">
					...
					<div class="location-about__item location-about__item-1">
						...
						<div class="location-about__text">
							...
							<p class="location-about__paragraph"><span class="orange-text"><?=$mes['Маленький Париж']?></p>
						</div>
					</div>
					<div class="location-about__item location-about__item-2">
						<div class="location-about__text">
							<p class="location-about__title"><?=$mes['Успевать всё']?></p>
							<p class="location-about__paragraph"><?=$mes['Купив апартаменты в']?></p>
						</div>
						<div class="location-about-pict">
					...
					<div class="location-about__item location-about__item-1">
						...
						<div class="location-about__text">
							...
							<p class="location-about__paragraph"><?=$mes['Одесса, прежде всего, ассоциируется']?></p>
						</div>
					</div>
					<div class="location-about__item location-about__item-2">
						<div class="location-about__text">
		...
		<style>
		.grad__title_text {font-size: 39px;}
		.location-main {
			position: relative;
			min-height: 100%;
			background: url(/img/happiness-with-a-view-at-the-sea/happiness-with-a-view-at-the-sea-bg.jpg) 0 22% no-repeat;
